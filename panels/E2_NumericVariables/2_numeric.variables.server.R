...
output$form_class_interval_specified_interval <- renderUI({
  ...
  isolate({
    if (input$form_class_interval_method == "Specified intervals") {
      ...
      valmin <- list(fixedRow(column(12, paste0(
        "The minimum value of variable ", input$form.class.interval.column.select, " is ",
      ...
      valmax <- list(fixedRow(column(12, paste0(
        "The maximum value of variable ", input$form.class.interval.column.select, " is ",
