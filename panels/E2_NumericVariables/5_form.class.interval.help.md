...
This module forms class intervals from a numeric column.

- **Select a variable** The first dropdown menu is used to select a numeric
  variable.
...
- **Format change** Two different formats can be selected here. This has only
  influence on the format of the generated interval.
