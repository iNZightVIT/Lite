  ...
  isolate({
    if (!is.null(plot.par$x)) {
      ...
      if (INFTYPE == "regression") {
        ret = list(column(12, checkboxInput("inf.trend.linear", label = "linear", 
                   ...
                   column(12, checkboxInput("inf.trend.quadratic", label = "quadratic", 
                   ...
                   column(12, checkboxInput("inf.trend.cubic", label = "cubic", 
      ...
      if(input$hypTest %in% c("One sample t-test", "Two sample t-test", "Test proportion")) {
        ...
        if (!inf.par$is_survey) {
          ret = list(ret,
                     ...
                     column(9, selectInput(inputId = "hypAlt",
                                           label = NULL,
