        ...
        fixedRow(
          column(width = 12,
                 conditionalPanel(condition = "input.customize_plot == 1",
                                  ...
                                  radioButtons(inputId = "saveplottype", label = "Select the file type", choices = list("jpg", "png", "pdf")),
                 ...
                 conditionalPanel(condition = "input.customize_plot == 2",
                                  fixedRow(
                                    column(
                                      ...
                                      radioButtons(inputId = "saveplottype2", label = "Select the file type", choices = list("jpg", "png", "pdf")),
