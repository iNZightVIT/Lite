...
values can be separated by comma or every value needs to be on a new line. The
latter method is preferred so it is possible to have commas in the new column.
